...
// ---- Mechanic portal. What a mechanic sees. No admin surfaces on this mount.
...
// ---- Recruiting board. John only, behind the admin gate above.
app.use('/ops/recruiting', AUTH.requireAdmin, recruitment({
  scope: 'admin',
